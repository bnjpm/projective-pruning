...
def resnext50(num_classes):
    ...
    return ResNext(ResNextBottleNeckC, [3, 4, 6, 3], num_classes=num_classes)


def resnext101(num_classes):
    """return a resnext101(c32x4d) network"""
    return ResNext(ResNextBottleNeckC, [3, 4, 23, 3], num_classes=num_classes)


def resnext152(num_classes):
    """return a resnext101(c32x4d) network"""
    return ResNext(ResNextBottleNeckC, [3, 4, 36, 3], num_classes=num_classes)
